...
- (void)setBorderButtonColor:(UIColor *)borderButtonColor
{
    ...
    self.buttonLeft.backgroundColor = [UIColor cyanColor];
    self.buttonRight.backgroundColor = [UIColor cyanColor];
}
...
{
    if (!_pickerView) {
        CGFloat pickerW = self.contentView.width - 30;
        ...
        [_pickerView setBackgroundColor:[UIColor cyanColor]];
    }
    return _pickerView;
}
